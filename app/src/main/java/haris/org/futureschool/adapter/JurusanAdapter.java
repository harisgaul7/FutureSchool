...
public class JurusanAdapter extends RecyclerView.Adapter<JurusanAdapter.ViewHolder> {
    ...
    public JurusanAdapter(final List<ExpandableModel> data) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        ...
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.row_jurusan, parent, false));
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.isi.setText(item.rincian);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            isi = (JustifiedTextView)v.findViewById(R.id.isi_expand);
