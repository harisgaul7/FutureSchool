...
public class FilterBiayaAwalModel {
    int id_sekolah;
    String gambar_sekolah, nama_sekolah, alamat_sekolah, deskripsi_sekolah, akreditasi_sekolah, visi_misi_sekolah, kurikulum_sekolah, slide_sekolah, jumlah_awal;
